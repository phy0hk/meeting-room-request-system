...
// @ts-nocheck 
/*
 * This file exports the `tblBookings` model and its related types.
 *
...
export type GetTblBookingsAggregateType<T extends TblBookingsAggregateArgs> = {
      [P in keyof T & keyof AggregateTblBookings]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateTblBookings[P]>
    : Prisma.GetScalarType<T[P], AggregateTblBookings[P]>
}
...
type GetTblBookingsGroupByPayload<T extends tblBookingsGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<TblBookingsGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof TblBookingsGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], TblBookingsGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], TblBookingsGroupByOutputType[P]>
      }
    >
  >
...
export type tblBookingsCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<tblBookingsFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface tblBookingsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['tblBookings'], meta: { name: 'tblBookings' } }
  /**
   ...
   * })
  **/
  count<T extends tblBookingsCountArgs>(
    args?: Prisma.Subset<T, tblBookingsCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], TblBookingsCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends tblBookingsGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, tblBookingsGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetTblBookingsGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
