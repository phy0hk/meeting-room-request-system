...
// @ts-nocheck 
/*
 * This file exports the `tblUsers` model and its related types.
 *
...
export type GetTblUsersAggregateType<T extends TblUsersAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateTblUsers[P]>
    : Prisma.GetScalarType<T[P], AggregateTblUsers[P]>
}
...
type GetTblUsersGroupByPayload<T extends tblUsersGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<TblUsersGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof TblUsersGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], TblUsersGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], TblUsersGroupByOutputType[P]>
      }
    >
  >
...
export type tblUsersCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface tblUsersDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends tblUsersCountArgs>(
    args?: Prisma.Subset<T, tblUsersCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], TblUsersCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, tblUsersGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetTblUsersGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
