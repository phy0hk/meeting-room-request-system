...
export const AuthorizeAllUserRoles = async (req, res, next) => {
    await Authenticate(req);
    next();
};
//Allow only user with admin role
export const AuthorizeAdminOnly = async (req, res, next) => {
...
export const AuthorizeOwnerOnly = async (req, res, next) => {
    const userInfo = await Authenticate(req);
...
export const AuthorizeAdminAndOwner = async (req, res, next) => {
    const userInfo = await Authenticate(req);
